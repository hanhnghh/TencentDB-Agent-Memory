...
// Skill bridge: LLM curls land here, proxy injects auth + identity, forwards to core.
  ...
  app.post("/dsh/:spaceId/v1/chat/completions", handleOpenAI);
  app.post("/dsh/:spaceId/chat/completions", handleOpenAI);
  ...
  if (config.costGuard.markerOptIn) {
    app.post("/dsh/:spaceId/cost-guard/v1/chat/completions", handleOpenAI);
    app.post("/dsh/:spaceId/cost-guard/chat/completions", handleOpenAI);
  }
  if (config.injection?.assetReflection?.markerOptIn) {
    app.post("/dsh/:spaceId/analyse/v1/chat/completions", handleOpenAI);
    app.post("/dsh/:spaceId/analyse/chat/completions", handleOpenAI);
  }
  ...
  if (config.costGuard.markerOptIn) {
    app.post("/opencode/:spaceId/cost-guard/v1/chat/completions", handleOpenAI);
    app.post("/opencode/:spaceId/cost-guard/chat/completions", handleOpenAI);
  }
  if (config.injection?.assetReflection?.markerOptIn) {
    app.post("/opencode/:spaceId/analyse/v1/chat/completions", handleOpenAI);
    app.post("/opencode/:spaceId/analyse/chat/completions", handleOpenAI);
  }
