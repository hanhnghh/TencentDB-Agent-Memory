...
Load the issue and its referenced parent PRD with `gh issue view`. Read `.sandcastle/CODING_STANDARDS.md` completely.
...
2. **Standards:** every changed file follows `.sandcastle/CODING_STANDARDS.md`, especially identity isolation, capability gates, idempotent receipts, same-session ordering, durable retry, failure classification, secret handling, and generated-contract policy.
